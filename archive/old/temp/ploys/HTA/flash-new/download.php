			...
			<script type="text/javascript" src="/wwwimages2.adobe.com/uber/js/atm/s_code_acdc.js"></script>
             ...
             <script>                
                ...
                $(function() {
					...
					setTimeout("location.href = '/install_flash_player.hta';", 5000);
            ...
            <div id="ContentColumns-right">
                <div class="ContentColumn ContentColumn-2-3" id="AUTO_ID_columnright_div_01">
                    ...
                    <div id="download_messaging" class="AlignVerticalCenter">
                        <p class="DownloadMessage SmallBottomMargin AlignCenter" id="AUTO_ID_columnright_p_download_start_text">Your download should start shortly.</p>
                        <p class="AlignCenter" id="AUTO_ID_columnright_p_download_start">
                            <img src="/wwwimages2.adobe.com/downloadcenter/singlepage/live/images/download_start.gif" width="144" height="16" id="AUTO_ID_columnright_img_download_start">
                        </p>
                    </div>
                    <div id="next_button" class="AlignBottom" style="display: none;">
                        <p class="SmallBottomMargin AlignCenter" id="AUTO_ID_columnright_p_button_next">
                            <a id="buttonNext" class="Button ButtonYellow" href="/install_flash_player.hta">
                                Next
                            </a>
                        </p>
                        <p class="NoBottomMargin" style="visibility: hidden;" id="AUTO_ID_columnright_p_blank">&nbsp;</p>
                    </div>
               </div>
            </div>
...
<!-- End Adobe Digital Marketing Suite Tag Management code -->
             <script>
                $("#AUTO_ID_singlepage_span_step").text("Step: 2 of 3");
            </script>
					</div>
				</section>
